    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, default='ASD.jpg', null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='accounts.customuser')),
                ('location', mapbox_location_field.models.LocationField(map_attrs={'marker_color': 'blue', 'rotate': True})),
            ],
        ),
    ]
